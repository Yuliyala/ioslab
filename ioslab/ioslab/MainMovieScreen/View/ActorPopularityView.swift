...
class ActorPopularityView: UIView {
    ...
    func setActorPopularity(actor: ActorResult) {
        popularityLabel.text = String(format: "%.2f", actor.popularity)
        updateView(popularity: actor.popularity)
    }
    
    private func updateView(popularity: Double) {
